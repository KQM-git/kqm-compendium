<template>
  <div class="bg-[#28242c] p-5 rounded-xl text-white">
    <div class="w-full relative">
      <div class="inline text-4xl font-bold">
        {{ composition.title }}
      </div>
      <div class="inline absolute bottom-0 right-0 text-gray-500 text-xl">
    ...
    <div class="w-full flex flex-row space-x-2 justify-center p-3">
      ...
      >
        ...
        <div class="w-full bg-gray-700 relative z-10 rounded-b-lg grid grid-cols-2 justify-center items-center space-x-0.5 p-1">
          <div class="bg-gray-900 grow w-full h-full rounded-lg flex flex-row justify-center items-center">
            <img
              :src="require(`~/assets/weapons/${character.weapon.name}.png`)"
              class="inline w-full"
            >
            <p class="text-xs font-bold pr-1">
